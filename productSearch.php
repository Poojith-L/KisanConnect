	...
	<body class="landing">
		...
		<!-- Footer -->
			...
			<div class="footer-left">
				...
				<p style="font-size:20px;color:white">Kisan is God<br/>& We are devotees !!!</p>
				<br />
			</div>
			...
			<div class="footer-center">
				...
				<div>
					...
					<p style="font-size:20px"><a href="mailto:artistkattawce@gmail.com" style="color:white">lpoojith9@gmail.com</a></p>
				</div>
			</div>
