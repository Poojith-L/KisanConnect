	...
	?>
		...
		<!-- Banner -->
			<section id="banner" class="wrapper">
				<div class="container">
				<h2>KisanConnect</h2>
				<p>Bringing the farm closer to your home</p>
				<br><br>
				<center>
		...
		<!-- One -->
			<section id="one" class="wrapper style1 align-center">
				<div class="container">
					<header>
						<h2>KisanConnect</h2>
						<p>Experience the flavor of fresh farm...</p>
					</header>
					<div class="row 200%">
		...
		<div class="footer-left">
			<h3 style="font-family: 'Times New Roman', cursive;">KisanConnect &copy;</h3>
			<h4 style="font-family: 'Times New Roman', cursive;">Developed by Poojith L</h4>
		<!--	<div class="logo">
				<a href="index.php"><img src="images/logo.jpg" width="200px"></a>
			</div>-->
			<br />
			<p style="font-size:20px;color:white">Bringing the farm closer to your home !!!</p>
			<br />
		</div>
		...
		<div class="footer-center">
			<div>
				...
				<p style="font-size:20px">KisanConnect Services<span>Bengaluru</span></p>
			</div>
			<div>
				<i class="fa fa-phone"></i>
				<p style="font-size:20px">7022747501</p>
			</div>
			<div>
				<i class="fa fa-envelope"></i>
				<p style="font-size:20px"><a href="mailto:lpoojith9@gmail.com" style="color:white">lpoojith9@gmail.com</a></p>
			</div>
		</div>

		<div class="footer-right">
			<p class="footer-company-about" style="color:white">
				<span style="font-size:20px"><b>About KisanConnect</b></span>
